...
sys.path.append(os.path.join(projectDir, "display/"))
...
class MagicBox:
    ...
    def SetRandomTag(self):
        tagID = random.randint(0, config.maxTagNr)
        self.ShowAprilTag(tagID)
        self._setManual = True
